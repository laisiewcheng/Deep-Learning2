...
def main():
    ...
    print('train setting file: %s ' %(train_setting_file))
    train_split_file = os.path.join(args.settings, args.dataset, train_setting_file)                                                                         
    print('train split file: %s' %(train_split_file))
    val_setting_file = "val_%s_split%d.txt" % (args.modality, args.split)
    print('val setting file: %s' %(val_setting_file))
    val_split_file = os.path.join(args.settings, args.dataset, val_setting_file)                                                                             
    print('val split file: %s' %(val_split_file))
